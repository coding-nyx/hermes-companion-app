...
def _prompt(_info=None) -> str:
    ...
    return (
        ...
        "does not lock while you plan. Loop: snapshot, tap with text= or @eN, use the snapshot returned on "
        "the gesture (old refs die), click a field before mobile_type, wait after open_app. "
